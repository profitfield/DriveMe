import { Controller, Get, Post, Patch, Param, Body, Query, ParseEnumPipe, NotFoundException } from '@nestjs/common';
import { ApiTags, ApiOperation, ApiResponse, ApiQuery } from '@nestjs/swagger';
import { DriversService } from '../services/drivers.service';
import { CreateDriverDto, UpdateDriverStatusDto } from '../dto/driver.dto';
import { CarClass, Driver } from '../entities/driver.entity';
...
export class DriversController {
  ...
  async updateLocation(
    @Body() location: { latitude: number; longitude: number; driverId: string }
  ) {
    // TODO: Реализовать обновление локации
    // return this.driversService.updateLocation(location);
  }
